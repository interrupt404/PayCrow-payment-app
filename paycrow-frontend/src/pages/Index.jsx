    ...
    <div>
      ...
      <div className="xsm:block xsm:mt-36 md:flex md:justify-around lg:flex lg:justify-around md:flex-wrap md:flex-row-reverse md:mt-20 lg:flex-row-reverse xl:mt-4 xl:justify-between  ">
        ...
        >
          ...
          <Lottie
            className=" xsm:size-48 sm:size-56 mx-auto  md:size-60 lg:size-72 xl:size-96 "
            animationData={Landing}
          />
        </motion.div>

        <div className="left-side xsm:mt-8 xsm:ml-4 xsm:text-center md:text-left xl:mt-44 md:mt-32">
          <motion.div
            animate={{
              x: [-100, 0],
            }}
